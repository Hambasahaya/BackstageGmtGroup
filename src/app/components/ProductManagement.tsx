  ...
  const handleCSVImport = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = async (event) => {
      ...
      try {
        ...
        if (photoIdx === -1) photoIdx = headers.indexOf("link_foto");
        if (photoIdx === -1) photoIdx = headers.indexOf("url_foto");
        ...
        for (let i = 0; i < totalRows; i++) {
          ...
          const rawPhoto = photoIdx !== -1 ? row[photoIdx]?.trim() || "" : "";
          ...
          if (existing) {
            ...
            const photoChanged = Boolean(rawPhoto && rawPhoto !== existing.foto);
            ...
            if (hasChanges) {
              try {
                ...
                const payload = {
                  ...
                  ...(rawPhoto ? { foto: rawPhoto } : (existing.foto ? { foto: existing.foto } : {})),
                };
